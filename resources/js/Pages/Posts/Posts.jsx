                            ...
                            {posts.map((post) => (
                                ...
                                >
                                    <div className="relative m-0 w-2/5 shrink-0 overflow-hidden rounded-xl rounded-r-none bg-white bg-clip-border text-gray-700">
                                        <a
                                            href=""
                                            className="bg-red-100 rounded-full hover:text-orange-600 absolute z-30 top-2 right-0 mt-2 mr-3"
                                        >
                                            <svg
                                    ...
                                    <div className="p-6">
                                        <Link
                                            href={`/posts/${post.id}`}
                                            className="mb-4 block text-base font-semibold uppercase leading-relaxed tracking-normal text-pink-500 antialiased"
                                        >
                                            {post.title}
                                        </Link>
