                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-sm">
                    ...
                    <div>
                        <Link href="/" className="!no-underline flex items-center mb-4">
                            <ApplicationLogo className="h-12 w-auto text-gray-800 me-4" />
                            <h3 className="text-3xl font-black text-gray-900">Baby Shop</h3>
                        </Link>
                        <p>
                    ...
                    {/* Column 2: About */}
                    <div>
                        <h4 className="text-lg font-bold mb-3">Meet Baby Shop</h4>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/support" className="hover:underline">Customer Support</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/category/toys" className="hover:underline">Toys</Link></li>
                            <li><Link href="/category/accessories" className="hover:underline">Accessories</Link></li>
                            <li><Link href="/category/gifts" className="hover:underline">Gifts</Link></li>
                        </ul>
                    </div>
