    ...
    return (
        <div className="flex min-h-screen">
            <div className="flex flex-row w-full">
                ...
                <div className="lg:w-2/3 w-full flex flex-1 flex-col items-center justify-center px-10 relative">
                    {/* Brand */}
                    ...
                    <div className="md:flex flex-row w-full justify-between text-center my-8">
                        {/* copy right */}
